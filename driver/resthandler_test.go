...
`
	...
	tests := []struct {
		...
		{"Test A Int8-", "-101", int8(-101), common.ValueTypeInt8, "", "text/plain", false},
		{"Test A Int8 converted by float value", "-101.98", int8(-101), common.ValueTypeInt8, "", "text/plain", false},
		...
		{"Test A Int32-", "-32000", int32(-32000), common.ValueTypeInt32, "", "text/plain", false},
		{"Test A Int32 converted by float value", "-32.456", int32(-32), common.ValueTypeInt32, "", "text/plain", false},
		{"Test A Int64+", "214748364800", int64(214748364800), common.ValueTypeInt64, "", "text/plain", false},
		{"Test A Int64-", "-214748364800", int64(-214748364800), common.ValueTypeInt64, "", "text/plain", false},
		{"Test A Int64 converted by float value", "-21474.99", int64(-21474), common.ValueTypeInt64, "", "text/plain", false},
