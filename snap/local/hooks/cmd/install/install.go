...
func installConfig() error {
	...
	path := "/config/device-rest/res/configuration.toml"
...
func installDevices() error {
	...
	path := "/config/device-rest/res/devices/sample-devices.toml"
	destFile := hooks.SnapData + path
	srcFile := hooks.Snap + path
...
func installDevProfiles() error {
	...
	for _, v := range profs {
		path := fmt.Sprintf("/config/device-rest/res/profiles/sample-%s-device.yaml", v)
		destFile := hooks.SnapData + path
		srcFile := hooks.Snap + path
